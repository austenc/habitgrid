<div>
    @if ($user->photo)
        <img src="/{{ $user->photo }}" class="inline-block rounded-full w-10 h-10">
    @else
        <div class="bg-gray-700 shadow w-10 h-10 rounded-full text-gray-500 transition duration-300 hover:text-gray-300">
